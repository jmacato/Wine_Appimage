...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-devel_4.6~bionic_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-devel-i386_4.6~bionic_i386.deb

dpkg -x wine-devel_4.6~bionic_i386.deb wineversion/
dpkg -x wine-devel-i386_4.6~bionic_i386.deb wineversion/
