...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-staging_4.6~bionic_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-staging-i386_4.6~bionic_i386.deb

dpkg -x wine-staging_4.6~bionic_i386.deb wineversion/
dpkg -x wine-staging-i386_4.6~bionic_i386.deb wineversion/
