...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-staging_5.0~rc2~buster_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-staging-i386_5.0~rc2~buster_i386.deb

dpkg -x wine-staging_5.0~rc2~buster_i386.deb wineversion/
dpkg -x wine-staging-i386_5.0~rc2~buster_i386.deb wineversion/
