...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/stretch/main/binary-i386/wine-devel_5.0~rc2~stretch_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/stretch/main/binary-i386/wine-devel-i386_5.0~rc2~stretch_i386.deb

dpkg -x wine-devel_5.0~rc2~stretch_i386.deb wineversion/
dpkg -x wine-devel-i386_5.0~rc2~stretch_i386.deb wineversion/
