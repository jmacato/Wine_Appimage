...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-devel_5.0~rc2~buster_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-devel-i386_5.0~rc2~buster_i386.deb

dpkg -x wine-devel_5.0~rc2~buster_i386.deb wineversion/
dpkg -x wine-devel-i386_5.0~rc2~buster_i386.deb wineversion/
